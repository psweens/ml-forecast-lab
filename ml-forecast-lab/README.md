...
- [docs/MODEL_GUIDE.md](https://github.com/psweens/ml-forecast-lab/blob/main/docs/MODEL_GUIDE.md) — which of the 31 backends to enable for your data shape and Pi compute budget.
