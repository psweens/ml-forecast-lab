...
class LSTMModel(ForecastModel):
    ...
    def fit(self, X_train: np.ndarray, y_train: np.ndarray, **kwargs: Any) -> Dict[str, Any]:
        ...
        # v2.40.12: best_val_loss tracks the raw val_loss for the
        ...
        for epoch in range(self.epochs):
            ...
            # Best-model checkpoint + early stopping (v2.40.12: shared
            # helper applies min_delta + EMA-smoothed stop decision).
